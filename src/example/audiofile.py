...
def test_image1 (infile = 'test.mp3',
                 outfile = 'test.jpg',
                 size_exponent = 10,
                 factor_exponent = 1):
  "batch sound --> image"
...
def test_image2 (infile = 'test.mp3',
                 outfile = 'test.jpg',
                 size_exponent = 10,
                 factor_exponent = 1):
...
def test_image3 (infile = 'test.mp3',
                 size_exponent = 9,
                 factor_exponent = 1):
...
def test_animate1 (infiles = None,
                   size_exponent = 10,
                   factor_exponent = 2):
  "animation with Supergram"

  if infiles is None: infiles = ['test.mp3']
  ...
  spline = K.transforms.Spline(screen.height,
                               super.super_size,
                               mapping)
...
def test_animate2 (infiles = None,
                   small_exponent = 9,
                   large_exponent = 11):
...
def test_animate3 (infiles = None,
                   small_exponent = 9,
                   large_exponent = 11):
...
def test_animate4 (infiles = None,
                   small_exponent = 9,
                   large_exponent = 11):
...
def test_images1 (infile = 'test.mp3',
                  small_exponent = 10,
                  large_exponent = 12,
                  color = True):
...
def test_images2 (infile = 'test.mp3',
                  small_exponent = 8,
                  large_exponent = 12,
                  size_out = 1 << 11,
                  color = True):
...
def test_images3 (infile = 'test.mp3',
                  small_exponent = 9,
                  large_exponent = 11,
                  size_out = 1 << 10,
                  color = True):
...
def test_history1 (infile = 'test.wav',
                   small_exponent = 9,
                   large_exponent = 10,
                   size = 1 << 9,
                   length = 1 << 9,
...
def test_history2 (infile = 'test.wav',
                   small_exponent = 9,
                   large_exponent = 12,
                   size = 1 << 10,
                   length = 1 << 9,
...
def test_shepard1 (infile = 'test.wav',
                   small_exponent = 9,
                   large_exponent = 11,
                   size = 1 << 10,
                   zoom_factor = 5,
