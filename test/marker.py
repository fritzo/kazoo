...
def draw_ring2(size, radius, x0, y0):
  return ( _draw_ring(size, x0, y0, radius, radius * 2 / 3)
         + draw_dot(size, radius / 3, x0, y0)
         )

@draw_('ring3')
def draw_ring3(size, radius, x0, y0):
  return ( _draw_ring(size, x0, y0, radius * 4 / 4, radius * 3 / 4)
         + _draw_ring(size, x0, y0, radius * 2 / 4, radius * 1 / 4)
         )

@draw_('ring4')
def draw_ring4(size, radius, x0, y0):
  return ( _draw_ring(size, x0, y0, radius * 5 / 5, radius * 4 / 5)
...
def draw_dots3(size, radius, x0, y0):
  ...
  dx = radius / sqrt(3)
  dy = radius / 2.0
  return ( draw_dot(size, r, x0 + dx, y0)
